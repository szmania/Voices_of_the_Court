...
### 鸣谢与归属
本项目是基于 VOTC / AliChat 的衍生作品。我们衷心感谢那些维持本项目活力并推动《十字军之王III》中人工智能边界的开发者们：

**原创者**: VOTC 团队及社区贡献者。感谢 Durond 和 MrAndroPC。

**持续开发**: 特别感谢中国开发社区，包括 Lisiyuan233、zhaowendao2005 等提供了关键更新和支持的成员。

**社区支持**: 感谢广大社区为本项目提供的见解、反馈和历史背景。

**社区版维护者**: VOTC-CE 团队及贡献者。

### 许可信息
本模组的部分原始材料采用知识共享署名-相同方式共享 4.0 国际 (CC BY-SA 4.0) 许可协议发布。

根据 CC BY-SA 4.0 许可协议第 4(b) 条，本衍生作品采用与 BY-SA 兼容的许可证：GNU 通用公共许可证 v3.0 (GPLv3) 进行许可。
...
本程序是基于它将有用的希望而分发的，但不提供任何保证；甚至没有对适销性或特定用途适用性的默示保证。更多详情请参阅 GNU 通用公共许可证。
