...
export class Conversation{
    ...
    loadConfig(){
        ...
        if (configToLog.textGenerationApiConnectionConfig?.connection?.key) {
            configToLog.textGenerationApiConnectionConfig.connection.key = "[REDACTED]";
        }
        if (configToLog.summarizationApiConnectionConfig?.connection?.key) {
            configToLog.summarizationApiConnectionConfig.connection.key = "[REDACTED]";
        }
        if (configToLog.actionsApiConnectionConfig?.connection?.key) {
