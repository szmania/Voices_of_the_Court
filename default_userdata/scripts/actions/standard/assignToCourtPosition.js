    ...
    args: [
        {
            ...
            type: "string",
            options: [
                { value: "Court Physician", display: { en: "Court Physician", zh: "御医", ru: "Придворный врач", fr: "Médecin de cour", es: "Médico de la corte", de: "Hofarzt", ja: "宮廷医師", ko: "궁정 의사", pl: "Lekarz dworski" }},
                { value: "Keeper of Swans", display: { en: "Keeper of Swans", zh: "天鹅官", ru: "Смотритель лебедей", fr: "Gardien des cygnes", es: "Guardián de los cisnes", de: "Schwanenwärter", ja: "白鳥官", ko: "백조 관리자", pl: "Strażnik łabędzi" }},
                { value: "Travel Leader", display: { en: "Travel Leader", zh: "旅行领队", ru: "Лидер путешествий", fr: "Chef de voyage", es: "Líder de viaje", de: "Reiseleiter", ja: "旅行隊長", ko: "여행 리더", pl: "Przywódca podróży" }},
                { value: "Master of Horse", display: { en: "Master of Horse", zh: "马厩总管", ru: "Конюший", fr: "Maître des chevaux", es: "Maestro de caballos", de: "Pferdemeister", ja: "厩舎長", ko: "마구간 총관", pl: "Mistrz koni" }},
                { value: "Court Jester", display: { en: "Court Jester", zh: "宫廷小丑", ru: "Придворный шут", fr: "Bouffon de cour", es: "Bufón de la corte", de: "Hofnarr", ja: "宮廷道化師", ko: "궁정 어릿광대", pl: "Nadworny błazen" }},
                { value: "Master of Hunt", display: { en: "Master of Hunt", zh: "狩猎主管", ru: "Мастер охоты", fr: "Maître de chasse", es: "Maestro de caza", de: "Jagdmeister", ja: "狩猟長", ko: "사냥 총관", pl: "Mistrz polowania" }},
                { value: "High Almoner", display: { en: "High Almoner", zh: "大施赈官", ru: "Верховный милостынедатель", fr: "Grand aumônier", es: "Gran limosnero", de: "Großalmosenier", ja: "大施与官", ko: "대시진관", pl: "Wielki jałmużnik" }},
                ...
                { value: "Court Tutor", display: { en: "Court Tutor", zh: "导师", ru: "Придворный наставник", fr: "Précepteur de cour", es: "Tutor de la corte", de: "Hoflehrer", ja: "宮廷教師", ko: "궁정 교사", pl: "Nauczyciel dworski" }},
                { value: "Royal Architect", display: { en: "Royal Architect", zh: "建筑师", ru: "Королевский архитектор", fr: "Architecte royal", es: "Arquitecto real", de: "Königlicher Architekt", ja: "王室建築家", ko: "왕실 건축가", pl: "Królewski architekt" }},
                { value: "Court Poet", display: { en: "Court Poet", zh: "宫廷诗人", ru: "Придворный поэт", fr: "Poète de cour", es: "Poeta de la corte", de: "Hofdichter", ja: "宮廷詩人", ko: "궁정 시인", pl: "Nadworny poeta" }},
                ...
                { value: "Court Musician", display: { en: "Court Musician", zh: "音乐家", ru: "Придворный музыкант", fr: "Musicien de cour", es: "Músico de la corte", de: "Hofmusiker", ja: "宮廷音楽家", ko: "궁정 음악가", pl: "Nadworny muzyk" }},
                { value: "Food Taster", display: { en: "Food Taster", zh: "试食官", ru: "Дегустатор пищи", fr: "Goûteur", es: "Catador de comida", de: "Vorkoster", ja: "試食官", ko: "시식관", pl: "Próbujący jedzenia" }},
                { value: "Lady-in-Waiting", display: { en: "Lady-in-Waiting", zh: "侍女", ru: "Фрейлина", fr: "Dame d'honneur", es: "Dama de compañía", de: "Hofdame", ja: "侍女", ko: "시녀", pl: "Dworzanka" }},
                { value: "Chief Eunuch", display: { en: "Chief Eunuch", zh: "首席太监", ru: "Главный евнух", fr: "Eunuque en chef", es: "Eunuco jefe", de: "Obereunuch", ja: "首席宦官", ko: "수석 환관", pl: "Główny eunuch" }},
                { value: "Court Gardener", display: { en: "Court Gardener", zh: "宫廷园丁", ru: "Придворный садовник", fr: "Jardinier de cour", es: "Jardinero de la corte", de: "Hofgärtner", ja: "宮廷庭師", ko: "궁정 정원사", pl: "Nadworny ogrodnik" }},
                { value: "Chief Qadi", display: { en: "Chief Qadi", zh: "大法官", ru: "Главный кади", fr: "Cadi en chef", es: "Cadí jefe", de: "Oberkadi", ja: "大法官", ko: "대법관", pl: "Główny kadi" }},
                { value: "Wet Nurse", display: { en: "Wet Nurse", zh: "乳母", ru: "Кормилица", fr: "Nourrice", es: "Nodriza", de: "Amme", ja: "乳母", ko: "유모", pl: "Mamka" }},
