...
module.exports = {
    ...
    args: [
        {
            ...
            min: 1,
            desc: {
                en: "The amount of gold the source ({{character1Name}}) receives from the target ({{character2Name}}).",
    ...
    description: {
        en: `Executed when one character receives gold from another. The source (character1) is the RECEIVER. The target (character2) is the GIVER.`,
