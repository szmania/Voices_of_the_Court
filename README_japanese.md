...
### クレジットと帰属
このプロジェクトはVOTC / AliChatに基づく派生作品です。このプロジェクトを存続させ、Crusader Kings IIIにおけるAIの可能性を押し広げた開発者の皆様に深く感謝いたします：

**オリジナル制作者**: VOTCチームおよびコミュニティ貢献者。Durond氏とMrAndroPC氏に感謝します。

**継続的な開発**: Lisiyuan233氏、zhaowendao2005氏など、重要なアップデートとサポートを提供してくださった中国の開発コミュニティに特に感謝します。

**コミュニティサポート**: プロジェクトに関する洞察、フィードバック、歴史的背景を提供してくださった広範なコミュニティに感謝します。

**コミュニティ版メンテナー**: VOTC-CEチームおよび貢献者。

### ライセンス情報
このModのオリジナルソース素材の一部は、クリエイティブ・コモンズ 表示-継承 4.0 国際 (CC BY-SA 4.0) ライセンスの下でリリースされました。
...
### GPLv3通知
このプログラムはフリーソフトウェアです。フリーソフトウェア財団によって公開されたGNU一般公衆利用許諾書の条件（バージョン3またはそれ以降の任意のバージョン）に従って、再配布および/または変更することができます。

このプログラムは有用であることを期待して配布されていますが、いかなる保証もありません。商品性または特定目的への適合性の黙示的な保証さえもありません。詳細については、GNU一般公衆利用許諾書をご覧ください。

このプログラムと共にGNU一般公衆利用許諾書のコピーを受け取っているはずです。そうでない場合は、<https://www.gnu.org/licenses/>をご覧ください。
