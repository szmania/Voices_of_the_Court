...
### 크레딧 및 저작권
이 프로젝트는 VOTC / AliChat을 기반으로 한 파생 저작물입니다. 이 프로젝트를 계속 유지하고 Crusader Kings III에서 AI의 경계를 넓힌 개발자들에게 깊은 감사를 표합니다:

**원본 제작자**: VOTC 팀 및 커뮤니티 기여자. Durond와 MrAndroPC에게 감사합니다.

**지속적인 개발**: Lisiyuan233, zhaowendao2005 등 중요한 업데이트와 지원을 제공한 중국 개발 커뮤니티에 특별한 감사를 드립니다.

**커뮤니티 지원**: 프로젝트에 대한 통찰력, 피드백 및 역사적 맥락을 제공해준 광범위한 커뮤니티에 감사합니다.

**커뮤니티 에디션 관리자**: VOTC-CE 팀 및 기여자.

### 라이선스 정보
이 모드의 일부 원본 자료는 크리에이티브 커먼즈 저작자표시-동일조건변경허락 4.0 국제 (CC BY-SA 4.0) 라이선스로 배포되었습니다.

CC BY-SA 4.0 라이선스의 섹션 4(b)에 따라, 이 파생 저작물은 BY-SA 호환 라이선스인 GNU 일반 공중 사용 허가서 v3.0 (GPLv3)에 따라 라이선스가 부여됩니다.

- **원본 라이선스**: CC BY-SA 4.0
- **현재 라이선스**: GPLv3

### GPLv3 공지
이 프로그램은 자유 소프트웨어입니다. 자유 소프트웨어 재단이 공표한 GNU 일반 공중 사용 허가서의 조건에 따라, 라이선스 버전 3 또는 (귀하의 선택에 따라) 그 이후의 버전을 재배포하거나 수정할 수 있습니다.

이 프로그램은 유용할 것이라는 희망으로 배포되지만, 어떠한 보증도 하지 않습니다. 상품성 또는 특정 목적에의 적합성에 대한 묵시적인 보증조차 하지 않습니다. 자세한 내용은 GNU 일반 공중 사용 허가서를 참조하십시오.

이 프로그램과 함께 GNU 일반 공중 사용 허가서 사본을 받았어야 합니다. 그렇지 않은 경우 <https://www.gnu.org/licenses/>를 참조하십시오.
